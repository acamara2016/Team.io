...
class MyVerticallyCenteredModal extends React.Component {
    ...
    handleSubmit = e =>{
        e.preventDefault();
        axios.post('https://csci4177-individual-acamara.herokuapp.com/tickets/add', {
            "title": this.state.title,
            "body": this.state.description,
            "lane": this.state.lane,
            "User_idUser": "acamara"
        }).then(()=> console.log("New work item")).then(()=> window.location.reload(false))
    }
    render(){
        return (
            <Modal
            ...
            >
              ...
              <Modal.Body>
                      <Form.Group controlId="exampleForm.ControlInput1">
                          ...
                          <input className="form-control" name="title" onChange={this.handleInputChange} type="text" placeholder="title..." />
                      </Form.Group>

                      <Form.Group controlId="exampleForm.ControlTextarea1">
                          <Form.Label>Description of the work item</Form.Label>
                          <textarea className="form-control" name="description" onChange={this.handleInputChange} as="textarea" rows={3} />
                      </Form.Group>
              </Modal.Body>
              <Modal.Footer>
